...
import { Globe, Leaf, Wind, Droplets, Recycle, Award, Users, Mail, MapPin, Linkedin, Twitter, Zap, Lightbulb, Handshake, TrendingUp, TrendingDown, Barcode, Package, Building2, ArrowRight, CheckCircle2 } from 'lucide-react';
...
function App() {
  ...
  const content = {
    en: {
      ...
      vision: {
        ...
        visionTitle: 'Vision',
        visionText: 'Pioneering to provide Circular Economy technology in Saudi Arabia.',
        missionTitle: 'Mission',
        missionText: 'Responsibly providing high-quality sustainability solutions that add value to all stakeholders.',
      ...
      environmental: {
        ...
        subtitle: 'Oceans are suffering — we act responsibly to save our future.'
      },
      drivers: {
      ...
      flow: {
        ...
        description: 'These solutions are part of the Circulam platform, developed by Mustdam to support circular economy operations.',
        nodes: [
          {
            title: 'Collectors',
            label: 'Scan',
            description: 'A bounty-based system encouraging collectors to scan and submit materials.'
          },
          {
            title: 'Storers',
            label: 'Store',
            description: 'A marketplace that connects storers, recyclers, and manufacturers.'
          },
          {
            title: 'Producers',
            label: 'Return',
            description: 'Manufacturers reuse processed materials, reducing waste and emissions.'
          }
        ],
        ...
        benefits: [
          {
            ...
            description: 'Connecting industrial parties to maximize utilization and minimize waste.'
          },
          {
            title: 'Full Lifecycle Tracking Transparency',
            description: 'Easily monitor material movement via smart tracking.'
          },
          {
            title: 'Unified Trading and Recycling Platform',
            description: 'Collection, storage, sorting, and recycling within one ecosystem.'
          },
          {
            title: 'Accurate Data for Sustainability Decisions',
            description: 'Smart reports helping companies and investors assess environmental impact.'
          }
        ]
      },
      solutions: {
        ...
        items: [
          {
            ...
            description: 'A bounty incentive system for collectors to encourage material collection.'
          },
          {
            title: 'Materials Trading & Storage Platform',
            description: 'A market platform connecting storers, recyclers, and manufacturers.'
          },
          {
            title: 'Lifecycle Tracking via Barcodes',
            description: 'Tracking product lifecycle from manufacturing to end-user using labels.'
          },
          {
            title: 'Environmental Impact Analytics & Data',
            description: 'Big-data insights to help investors and regulators measure environmental impact.'
          }
        ]
      },
      projects: {
        title: 'Our Projects',
        items: [
          { name: 'Circulam', description: 'Circular economy platform', link: 'https://www.circulam.net', logo: 'https://www.circulam.net/icons/circulam.png' }
        ]
      },
      contact: {
        title: 'Contact Us',
    ...
    ar: {
      ...
      vision: {
        ...
        visionTitle: 'الرؤية',
        visionText: 'الريادة في تقديم تقنيات الاقتصاد الدائري في المملكة العربية السعودية.',
        missionTitle: 'الرسالة',
        missionText: 'تقديم حلول استدامة عالية الجودة تضيف قيمة لجميع الأطراف المعنية.',
      ...
      flow: {
        ...
        description: 'تقدم هذه الحلول ضمن منصة سيركلوم، إحدى المنصات التي طورتها شركة مستدام لدعم الاقتصاد الدائري.',
        nodes: [
          {
            title: 'الجامعون',
            label: 'Scan',
        ...
        benefits: [
          {
            ...
            description: 'ربط الأطراف الصناعية لرفع الاستفادة وتقليل الفاقد.'
          },
          {
            title: 'شفافية كاملة في تتبع دورة الحياة',
            description: 'متابعة حركة المواد بسهولة عبر التتبع الذكي.'
          },
          {
            title: 'منصة موحّدة للتداول وإعادة التدوير',
            description: 'جمع، تخزين، وفرز وتدوير المواد عبر منظومة واحدة.'
          },
          {
            title: 'بيانات دقيقة تدعم قرارات الاستدامة',
            description: 'تقارير ذكية تساعد الشركات والمستثمرين على تقييم الأثر البيئي.'
          }
        ]
      },
      solutions: {
        ...
        items: [
          {
            ...
            description: 'نظام حوافز للمُجمّعين لتشجيع جمع المواد.'
          },
          {
            title: 'منصة تداول وتخزين المواد',
            description: 'منصة سوق تربط المخزّنين والمعيدين للتدوير والمصنّعين.'
          },
          {
            title: 'تتبّع دورة الحياة باستخدام الباركود',
            description: 'تتبّع دورة حياة المنتج من التصنيع حتى المستخدم النهائي عبر الملصقات.'
          },
          {
            title: 'تحليلات وبيانات للأثر البيئي',
            description: 'رؤى تعتمد على البيانات الضخمة لمساعدة المستثمرين والجهات المنظمة في قياس الأثر البيئي.'
          }
        ]
      },
      projects: {
        title: 'مشاريعنا',
        items: [
          { name: 'Circulam', description: 'منصة الاقتصاد الدائري', link: 'https://www.circulam.net', logo: 'https://www.circulam.net/icons/circulam.png' }
        ]
      },
      contact: {
        title: 'اتصل بنا',
  ...
  // Icon mapping for Vision values (4Cs)
  const valueIcons = [Handshake, Users, TrendingUp, Lightbulb];

  // Icon mapping for About points (contextual)
  ...
  return (
    <div className={`min-h-screen ${isRTL ? 'rtl' : 'ltr'}`} dir={isRTL ? 'rtl' : 'ltr'}>
          ...
          <div className="flex items-center justify-between h-24">
            <div className="flex items-center space-x-3 group">
              <div className="relative">
                ...
                <img src={logoImg} alt="Mustdam Logo" className="h-20 w-auto relative z-10 transition-transform duration-500 group-hover:scale-110" />
              </div>
            </div>

            <div className={`hidden md:flex items-center ${isRTL ? 'space-x-reverse' : ''} space-x-2 bg-white/60 backdrop-blur-md rounded-full px-2.5 py-2 shadow-inner ring-1 ring-white/40`}>
              <a
                href="#about"
            ...
            >
              ...
              <span className="font-semibold relative z-10">{language === 'en' ? 'العربية' : 'English'}</span>
            </button>
          </div>
        </div>
      </nav>
        ...
        <div className="relative z-10 text-center px-4 max-w-6xl mx-auto">
          <div className="mb-12 relative">
            ...
            <div className="relative animate-float">
              <Leaf className="w-24 h-24 text-white mx-auto drop-shadow-2xl" strokeWidth={1.75} />
            </div>
          </div>
          ...
          <div className={`flex ${isRTL ? 'flex-row-reverse' : 'flex-row'} items-center gap-4 md:gap-5 justify-center animate-fade-in-delay-2 flex-wrap`}>
      ...
      {/* About Section */}
      <section id="about" className="py-32 bg-gradient-to-b from-white via-[#f8fdfb] to-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-20">
            <div className="inline-block mb-4">
              <span className="text-sm font-semibold text-[#5a8068] tracking-wider uppercase bg-[#f0f7f4] px-4 py-2 rounded-full">About Us</span>
            </div>
            <h2 className="text-4xl md:text-6xl font-bold text-[#2d4a3e] mb-4 leading-tight">{t.about.title}</h2>
                ...
                return (
                  <div key={index} className="group relative">
                    ...
                    <div className="relative flex items-start gap-5 bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition-all duration-500 group-hover:-translate-y-1 border border-gray-100">
                      <div className={`flex-shrink-0 w-10 h-10 bg-gradient-to-br from-[#3d5a4f] to-[#5a8068] rounded-full flex items-center justify-center shadow-md group-hover:scale-110 transition-transform duration-500 ${isRTL ? 'order-2' : 'order-1'}`}>
                        <Icon className="w-5 h-5 text-white" strokeWidth={1.6} />
                      </div>
                      <p className={`text-gray-800 flex-1 font-medium pt-1.5 text-lg ${isRTL ? 'order-1 pr-2 text-right' : 'order-2 pl-2 text-left'}`}>{point}</p>
                    </div>
                  </div>
                );
              })}
      ...
      <section id="vision" className="py-32 bg-gradient-to-b from-white via-[#f0f7f4] to-white relative overflow-hidden">
        <div className="absolute inset-0 opacity-5">
          <div className="absolute top-0 left-0 w-full h-full bg-[url('data:image/svg+xml;base64,')] opacity-20"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-20">
            <div className="inline-block mb-4">
              <span className="text-sm font-semibold text-[#5a8068] tracking-wider uppercase bg-white px-4 py-2 rounded-full shadow-sm">Our Foundation</span>
            </div>
            <h2 className="text-3xl md:text-5xl font-bold text-[#2d4a3e] mb-4 leading-tight">{t.vision.title}</h2>
            <SectionUnderline variant="gradient" compact animate="slide" />
          </div>
            ...
            <div className="group relative">
              ...
              >
                <div className="flex items-center gap-5 md:gap-6 mb-4">
                  ...
                  <h3 className={`text-lg md:text-xl font-semibold text-[#2d4a3e] tracking-tight ${isRTL ? 'text-right' : 'text-left'}`}>
          ...
          <h3 className="text-xl font-bold text-[#2d4a3e] mb-5 text-center">{t.vision.valuesTitle}</h3>
              ...
              return (
                <div key={index} className="group relative">
                  ...
                  <div className="relative bg-white p-7 rounded-2xl shadow-md hover:shadow-lg hover:-translate-y-3 transition-all duration-500 border border-gray-100 h-full">
                    ...
                    <h4 className="text-lg font-bold text-[#2d4a3e] mb-2 text-center">{value.title}</h4>
                    <p className="text-gray-600 text-base text-center leading-relaxed">{value.text}</p>
                  </div>
                </div>
              );
            })}
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="inline-block mb-8">
            <div className="px-6 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20">
              <span className="text-sm font-semibold text-white/90 tracking-wider uppercase">Our Mission</span>
            </div>
          </div>
          <h2 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">{t.environmental.title}</h2>
          <p className="text-2xl md:text-3xl text-white/90 font-light leading-relaxed max-w-4xl mx-auto">{t.environmental.subtitle}</p>
      ...
      <section className="py-32 bg-gradient-to-b from-white via-[#f8fdfb] to-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-20">
            <div className="inline-block mb-4">
              <span className="text-sm font-semibold text-[#5a8068] tracking-wider uppercase bg-[#f0f7f4] px-4 py-2 rounded-full">Sustainability Pillars</span>
            </div>
            <h2 className="text-4xl md:text-6xl font-bold text-[#2d4a3e] mb-4 leading-tight">{t.drivers.title}</h2>
            <SectionUnderline variant="capsule" compact animate="slide" />
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {t.drivers.items.map((item, index) => {
              const icons = [Wind, Zap, Recycle, Globe]; // Changed Leaf to Zap for Renewable Energy
              ...
              return (
                <div key={index} className="group relative h-full">
                  ...
                  <div className="relative bg-white p-7 rounded-3xl shadow-md hover:shadow-lg hover:-translate-y-3 transition-all duration-500 border border-gray-100 h-full flex flex-col">
                    ...
                    <h3 className="text-lg font-bold text-[#2d4a3e] mb-3">{item.title}</h3>
                    <p className="text-gray-600 text-sm md:text-base leading-relaxed flex-1">{item.description}</p>
      ...
      {/* Projects */}
      <section id="projects" className="py-32 bg-gradient-to-b from-white via-[#f8fdfb] to-white relative overflow-hidden">
        <div className="absolute inset-0 opacity-5">
          <div className="absolute bottom-20 left-20 w-96 h-96 bg-[#3d5a4f] rounded-full blur-3xl"></div>
          <div className="absolute top-40 right-20 w-96 h-96 bg-[#5a8068] rounded-full blur-3xl"></div>
        </div>

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-20">
            <div className="inline-block mb-4">
              <span className="text-sm font-semibold text-[#5a8068] tracking-wider uppercase bg-[#f0f7f4] px-4 py-2 rounded-full">Our Work</span>
            </div>
            <h2 className="text-4xl md:text-6xl font-bold text-[#2d4a3e] mb-4 leading-tight">{t.projects.title}</h2>
            <SectionUnderline variant="gradient" />
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {t.projects.items.map((project, index) => {
              ...
              const LogoElement = project.logo ? (
                <img
                  src={project.logo}
                  alt={`${project.name} logo`}
                  className="h-24 w-auto object-contain flex-shrink-0 transition-transform duration-300 group-hover:scale-105"
                />
              ) : null;

              const TextContent = (
                <div className="flex flex-col flex-1">
                  <h3 className="text-xl md:text-2xl font-bold text-[#2d4a3e] mb-4">{project.name}</h3>
                  <p className="text-gray-600 text-lg leading-relaxed flex-1 mb-6">{project.description}</p>
                </div>
              );

              const CardInner = (
                <div className="relative bg-white p-10 rounded-3xl shadow-lg transition-all duration-500 border border-gray-100 h-full flex flex-col">
                  {isLinked && LogoElement ? (
                    // Special layout for Circulam: Logo on the side (horizontal flex)
                    <div className={`flex items-center gap-8 h-full ${isRTL ? 'flex-row-reverse' : 'flex-row'}`}>
                    ...
                    // Default layout for non-linked projects: Vertical, no logo/icon
                  ...
                  <div className="pt-6 border-t border-gray-100 mt-auto">
                    <div className="w-full flex items-center justify-center py-3">
                      <div className="w-12 h-1.5 rounded-full bg-[#3d5a4f] shadow-[0_2px_6px_rgba(61,90,79,0.25)] transition-all duration-300 group-hover:w-14"></div>
                    </div>
                  </div>
                </div>
              );
      ...
      {/* Circulam Platform Solutions — Flow Diagram (moved below Projects) */}
      <section id="journey" className="py-32 bg-gradient-to-br from-[#f0f7f4] via-white to-[#f0f7f4] relative overflow-hidden">
        <div className="absolute inset-0 opacity-5">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-6xl font-bold text-[#2d4a3e] mb-4 leading-tight">{t.flow.title}</h2>
            <SectionUnderline variant="gradient" compact animate="slide" />
            {t.flow.description && (
          ...
          <div className="relative">
            ...
            <div className={`hidden md:flex absolute top-[calc(50%-12px)] left-0 right-0 px-24 items-center justify-between ${isRTL ? 'flex-row-reverse' : 'flex-row'}`}>
              <ArrowRight className={`w-6 h-6 text-[#3d5a4f]/70 ${isRTL ? 'rotate-180' : ''} animate-pulse`} />
              <ArrowRight className={`w-6 h-6 text-[#5a8068]/70 ${isRTL ? 'rotate-180' : ''} animate-pulse`} />
            </div>
            {/* Nodes */}
              ...
              {t.flow.nodes.map((node, idx) => {
                ...
                return (
                  <div key={idx} className="group relative">
                    <div className="absolute inset-0 bg-gradient-to-br from-[#3d5a4f] to-[#5a8068] rounded-3xl opacity-0 group-hover:opacity-100 blur-xl transition-all duration-500"></div>
                    <div className="relative bg-white p-7 md:p-8 rounded-3xl shadow-md hover:shadow-lg hover:-translate-y-2 transition-all duration-500 border border-gray-100 h-full" dir={isRTL ? 'rtl' : 'ltr'}>
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          <div className={`text-sm font-semibold tracking-wider text-[#5a8068] uppercase mb-1 ${isRTL ? 'text-right' : 'text-left'}`}>
                            {node.label}
                          </div>
                          <h3 className={`text-xl font-bold text-[#2d4a3e] mb-2 ${isRTL ? 'text-right' : 'text-left'}`}>{node.title}</h3>
                          <p className={`text-gray-600 text-base md:text-lg leading-relaxed ${isRTL ? 'text-right' : 'text-left'}`}>{node.description}</p>
                        </div>
                      </div>
          ...
          {/* Benefits */}
          <div className="mt-14">
            <h4 className="text-2xl font-bold text-[#2d4a3e] mb-4 text-center">{t.flow.benefitsTitle}</h4>
            <SectionUnderline variant="minimal" compact animate="slide" />
            <div className={`mt-6 grid sm:grid-cols-2 gap-4 ${isRTL ? 'rtl' : 'ltr'}`}>
              {t.flow.benefits.map((b: any, i: number) => {
                const isObject = typeof b === 'object' && b !== null;
                return (
                  <div key={i} className="flex items-start gap-3 bg-white/60 backdrop-blur-sm rounded-2xl p-4 border border-gray-100">
                    ...
                    <div className={`flex-1 ${isRTL ? 'text-right' : 'text-left'}`}>
                      {isObject ? (
                        <>
                          <p className="text-gray-900 font-semibold text-base md:text-lg">{b.title}</p>
                          <p className="text-gray-600 text-base mt-0.5">{b.description}</p>
                        </>
                      ) : (
                        <p className="text-gray-700 text-base md:text-lg">{b}</p>
                      )}
                    </div>
                  </div>
                );
      ...
      {/* Contact */}
      <section id="contact" className="py-32 bg-gradient-to-b from-white via-[#f0f7f4] to-white relative overflow-hidden">
        <div className="absolute inset-0 opacity-5">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-20">
            <div className="inline-block mb-4">
              <span className="text-sm font-semibold text-[#5a8068] tracking-wider uppercase bg-white px-4 py-2 rounded-full shadow-sm">Get In Touch</span>
            </div>
            <h2 className="text-4xl md:text-6xl font-bold text-[#2d4a3e] mb-4 leading-tight">{t.contact.title}</h2>
          ...
          <div className="grid md:grid-cols-2 gap-10 items-start">
            <div className="space-y-6 md:-mt-2">
              <div className="group relative">
                <div className="absolute inset-0 bg-gradient-to-br from-[#3d5a4f] to-[#5a8068] rounded-2xl opacity-0 group-hover:opacity-100 blur-xl transition-all duration-500"></div>
                <div className="relative bg-white p-9 rounded-2xl shadow-[0_8px_20px_rgba(0,0,0,0.05)] hover:shadow-lg transition-all duration-300 border border-gray-100" dir={isRTL ? 'rtl' : 'ltr'}>
                  <div className="flex items-center gap-5 sm:gap-6 mb-3.5">
                    ...
                    <h3 className={`font-bold text-lg md:text-xl text-[#2d4a3e] ${isRTL ? 'text-right' : 'text-left'}`}>{t.contact.circulam}</h3>
                  </div>
                  <div className="border-t border-gray-100 my-3"></div>
                  <a href="mailto:support@circulam.net" className={`text-[#5a8068] hover:text-[#3d5a4f] text-lg font-medium transition-colors block break-words ${isRTL ? 'text-right pr-[4.75rem] sm:pr-20' : 'text-left pl-[4.75rem] sm:pl-20'}`}>
              ...
              <div className="group relative">
                ...
                <div className="relative bg-white p-9 rounded-2xl shadow-[0_8px_20px_rgba(0,0,0,0.05)] hover:shadow-lg transition-all duration-300 border border-gray-100" dir={isRTL ? 'rtl' : 'ltr'}>
                  <div className="flex items-center gap-5 sm:gap-6 mb-3.5">
                    ...
                    <h3 className={`font-bold text-lg md:text-xl text-[#2d4a3e] ${isRTL ? 'text-right' : 'text-left'}`}>{t.contact.gases}</h3>
                  </div>
                  <div className="border-t border-gray-100 my-3"></div>
                  <a href="mailto:m.shehab@mustdam.com" className={`text-[#5a8068] hover:text-[#3d5a4f] text-lg font-medium transition-colors block break-words ${isRTL ? 'text-right pr-[4.75rem] sm:pr-20' : 'text-left pl-[4.75rem] sm:pl-20'}`}>
              ...
              <div className="group relative">
                ...
                <div className="relative bg-white p-9 rounded-2xl shadow-[0_8px_20px_rgba(0,0,0,0.05)] hover:shadow-lg transition-all duration-300 border border-gray-100" dir={isRTL ? 'rtl' : 'ltr'}>
                  <div className="flex items-center gap-5 sm:gap-6">
                    ...
                    <p className={`text-gray-800 text-lg font-medium ${isRTL ? 'text-right' : 'text-left'}`}>{t.contact.location}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative md:-mt-4">
              ...
              <form className="relative bg-white p-10 rounded-3xl shadow-[0_8px_20px_rgba(0,0,0,0.05)] space-y-6 border border-gray-100 max-w-xl mx-auto">
                ...
                <div className="relative z-10 space-y-6">
                  <div>
                    <label className="block text-gray-900 font-semibold mb-4 text-base uppercase tracking-wider">{t.contact.name}</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-gray-900 font-semibold mb-4 text-base uppercase tracking-wider">{t.contact.email}</label>
                    <input
                      type="email"
                      className="w-full px-5 py-4 border-2 border-gray-200 rounded-2xl focus:ring-2 focus:ring-[#3d5a4f] focus:border-[#3d5a4f] transition-all duration-300 bg-gray-50 focus:bg-white shadow-sm"
                      placeholder=""
                  ...
                  <div>
                    <label className="block text-gray-900 font-semibold mb-4 text-base uppercase tracking-wider">{t.contact.message}</label>
                    <textarea
                      rows={5}
      ...
      <footer className="bg-gradient-to-br from-[#1a2f28] via-[#2d4a3e] to-[#3d5a4f] text-white py-20 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center flex flex-col items-center">
            <p className="text-2xl md:text-3xl font-light mb-12 text-white/90 leading-relaxed animate-fade-in">{t.footer.text}</p>

            <div className="flex justify-center items-center space-x-10 mb-10">
              <a href="#" className="group w-16 h-16 p-3 bg-white/15 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-white/20 hover:scale-[1.06] transition-all duration-300 ring-1 ring-white/40 animate-fade-in-delay">
            ...
            {/* REPLACED: full-width border-top with a centered short divider */}
            <div className="w-full flex justify-center pt-6">
              <div className="w-28 h-px bg-white/40 rounded-full"></div>
            </div>
            <p className="text-white/60 text-xs mt-4">{t.footer.copyright}</p>
          </div>
        </div>
      </footer>
    </div>
